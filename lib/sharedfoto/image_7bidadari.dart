...
class Image7Bidadari extends StatefulWidget {
  @override
  _PhotoSharingPageState createState() => _PhotoSharingPageState();
}

class _PhotoSharingPageState extends State<Image7Bidadari> {
  ...
  Future<void> _uploadImage() async {
    ...
    await _firestore.collection('image_7bidadari').add({
      'imageUrl': imageUrl,
      'userId': _user!.uid,
      'username': _userName,
      'gambars': _gambar,
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => Image7Bidadari()),
    );
  }
