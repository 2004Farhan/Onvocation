...
class ImageGambir extends StatefulWidget {
  @override
  _PhotoSharingPageState createState() => _PhotoSharingPageState();
}

class _PhotoSharingPageState extends State<ImageGambir> {
  ...
  Future<void> _fetchImages() async {
    final QuerySnapshot snapshot =
        await _firestore.collection('image_gambir').get();
  ...
  Future<void> _uploadImage() async {
    ...
    await _firestore.collection('image_gambir').add({
      'imageUrl': imageUrl,
      'userId': _user!.uid,
      'username': _userName,
      'gambars': _gambar,
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ImageGambir()),
    );
  }
