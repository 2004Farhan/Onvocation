...
class ImageIjen extends StatefulWidget {
  @override
  _PhotoSharingPageState createState() => _PhotoSharingPageState();
}

class _PhotoSharingPageState extends State<ImageIjen> {
  ...
  Future<void> _fetchImages() async {
    final QuerySnapshot snapshot =
        await _firestore.collection('image_ijen').get();
  ...
  Future<void> _uploadImage() async {
    ...
    await _firestore.collection('image_ijen').add({
      'imageUrl': imageUrl,
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ImageIjen()),
    );
  }
