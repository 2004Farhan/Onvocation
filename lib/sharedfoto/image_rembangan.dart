...
class ImageRembangan extends StatefulWidget {
  @override
  _PhotoSharingPageState createState() => _PhotoSharingPageState();
}

class _PhotoSharingPageState extends State<ImageRembangan> {
  ...
  Future<void> _fetchImages() async {
    final QuerySnapshot snapshot =
        await _firestore.collection('image_rembangan').get();
  ...
  Future<void> _uploadImage() async {
    ...
    await _firestore.collection('image_rembangan').add({
      'imageUrl': imageUrl,
      'userId': _user!.uid,
      'username': _userName,
      'gambars': _gambar,
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ImageRembangan()),
    );
  }
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomShapeAppBar(
          child: AppBar(
            backgroundColor: Color.fromRGBO(20, 0, 92, 1.0),
            elevation: 0,
