...
class ImageWatuUlo extends StatefulWidget {
  @override
  _PhotoSharingPageState createState() => _PhotoSharingPageState();
}

class _PhotoSharingPageState extends State<ImageWatuUlo> {
  ...
  Future<void> _fetchImages() async {
    final QuerySnapshot snapshot =
        await _firestore.collection('image_watuulo').get();
  ...
  Future<void> _uploadImage() async {
    ...
    await _firestore.collection('image_watuulo').add({
      'imageUrl': imageUrl,
      'userId': _user!.uid,
      'username': _userName,
      'gambars': _gambar,
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ImageWatuUlo()),
    );
  }
