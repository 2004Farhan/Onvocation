...
import 'package:onvocation/sharedfoto/image_gambir.dart';

class G_gambir extends StatefulWidget {
  const G_gambir({Key? key}) : super(key: key);

  @override
  State<G_gambir> createState() => _MainScreenState();
}

class _MainScreenState extends State<G_gambir> {
  final String menuName = 'Gunung Gambir';
  String name = '';
  String category = '';
  String address = '';
  String price = '';
  ...
  LatLng destinationPosition = LatLng(-8.01530616504543, 113.44156021364279);
  ...
  Future<void> _launchURL(String url) async {
    final Uri uri = Uri.https("www.google.com",
        "maps/place/Gn.+Gambir/@-8.0166235,113.4207892,14z/data=!3m1!4b1!4m6!3m5!1s0x2dd6f68d5c702eed:0x83ab446d853932f4!8m2!3d-8.0166667!4d113.4413889!16s%2Fg%2F11c0pzyf84?entry=ttu");
    if (!await launchUrl(
      uri,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                                "https://firebasestorage.googleapis.com/v0/b/onvocation-81249.appspot.com/o/Gunung%20Gambir.jpg?alt=media&token=8549d80b-a361-4002-baf9-c109be1832f3&_gl=1*16pyzdv*_ga*MTAxMTI3MzE5Mi4xNjg1MTAyMzI2*_ga_CW55HF8NVT*MTY4NjU2MTU4MC44LjEuMTY4NjU2NzU0OS4wLjAuMA.."),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
