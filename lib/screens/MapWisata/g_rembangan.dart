...
import 'package:onvocation/sharedfoto/image_rembangan.dart';

class G_rembangan extends StatefulWidget {
  const G_rembangan({Key? key}) : super(key: key);

  @override
  State<G_rembangan> createState() => _MainScreenState();
}

class _MainScreenState extends State<G_rembangan> {
  final String menuName = 'Rembangan Public Bath';
  String name = '';
  String category = '';
  String address = '';
  String price = '';
  ...
  LatLng destinationPosition = LatLng(-8.07779359575618, 113.69065949867499);
  ...
  Future<void> _launchURL(String url) async {
    final Uri uri = Uri.https("www.google.com",
        "maps/place/Hotel+Rembangan/@-8.0802673,113.68508,15.94z/data=!4m6!3m5!1s0x2dd6eb6b22b4390b:0xcdcfa9792af9847c!8m2!3d-8.0785502!4d113.6904683!16s%2Fm%2F0_qcvd3?entry=ttu");
    if (!await launchUrl(
      uri,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                                "https://firebasestorage.googleapis.com/v0/b/onvocation-81249.appspot.com/o/rembangan-public-bath.jpg?alt=media&token=f6ca7858-f788-4d46-acac-37a113178a6a&_gl=1*1k4jm62*_ga*NTYyMDIyOTE4LjE2ODQxNzY3MzU.*_ga_CW55HF8NVT*MTY4NjMwMTU2OC4zMC4xLjE2ODYzMDUzNjUuMC4wLjA."),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ImageRembangan()),
                                );
                              },
                              child: Text(
                                'Upload Foto',
