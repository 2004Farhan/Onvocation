...
import 'package:onvocation/sharedfoto/image_ijen.dart';

class G_ijen extends StatefulWidget {
  const G_ijen({Key? key}) : super(key: key);

  @override
  State<G_ijen> createState() => _MainScreenState();
}

class _MainScreenState extends State<G_ijen> {
  final String menuName = 'Kawah Ijen';
  String name = '';
  String category = '';
  String address = '';
  String price = '';
  ...
  LatLng destinationPosition = LatLng(-8.057942692955463, 114.24315556950404);
  ...
  Future<void> _launchURL(String url) async {
    final Uri uri = Uri.https("www.google.com",
        "maps/place/Kawah+Ijen/@-8.0580595,114.2366324,16z/data=!3m1!4b1!4m6!3m5!1s0x2dd1360879927549:0xa9c052cab461fff1!8m2!3d-8.0584134!4d114.2412788!16s%2Fg%2F1214mf1m?entry=ttu");
    if (!await launchUrl(
      uri,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                                "https://firebasestorage.googleapis.com/v0/b/onvocation-81249.appspot.com/o/Kawah%20Ijen.jpg?alt=media&token=59272a68-c296-4184-bb1b-3c9f18736bcb&_gl=1*1ricalh*_ga*MTAxMTI3MzE5Mi4xNjg1MTAyMzI2*_ga_CW55HF8NVT*MTY4NjU2MTU4MC44LjEuMTY4NjU2ODQ1MC4wLjAuMA.."),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
