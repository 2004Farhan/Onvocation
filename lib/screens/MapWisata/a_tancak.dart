...
class A_tancak extends StatefulWidget {
  const A_tancak({Key? key}) : super(key: key);

  @override
  State<A_tancak> createState() => _MainScreenState();
}

class _MainScreenState extends State<A_tancak> {
  final String menuName = 'Air Terjun Tancak';
  String name = '';
  String category = '';
  String address = '';
  String price = '';
  ...
  LatLng destinationPosition = LatLng(-8.0648719, 113.6163754);
  ...
  Future<void> _launchURL(String url) async {
    final Uri uri = Uri.https("www.google.com",
        "maps/place/Air+Terjun+Tancak/@-8.0648719,113.6163754,17z/data=!4m6!3m5!1s0x2dd6edaa995f359d:0x7f2c804aeecf2dda!8m2!3d-8.0648772!4d113.6189503!16s%2Fg%2F11bvvx4n9j?entry=ttu");
    if (!await launchUrl(
      uri,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                                "https://firebasestorage.googleapis.com/v0/b/onvocation-81249.appspot.com/o/25b4997be4bd9ba216b5ca599a3e0d1c.jpg?alt=media&token=66b94748-4085-4cc5-8b02-1b228f216820&_gl=1*4odp39*_ga*NTYyMDIyOTE4LjE2ODQxNzY3MzU.*_ga_CW55HF8NVT*MTY4NjMwMTU2OC4zMC4xLjE2ODYzMDUyMTYuMC4wLjA.."),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
