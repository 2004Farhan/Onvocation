...
import 'package:onvocation/sharedfoto/image_payangan.dart';

class P_payangan extends StatefulWidget {
  const P_payangan({Key? key}) : super(key: key);

  @override
  State<P_payangan> createState() => _MainScreenState();
}

class _MainScreenState extends State<P_payangan> {
  final String menuName = 'Pantai Payangan';
  String name = '';
  String category = '';
  String address = '';
  String price = '';
  ...
  LatLng destinationPosition = LatLng(-8.433946147784527, 113.58061200721082);
  ...
  Future<void> _launchURL(String url) async {
    final Uri uri = Uri.https("www.google.com",
        "maps/place/Pantai+payangan/@-8.4364037,113.5787241,17z/data=!4m14!1m7!3m6!1s0x2dd4272ca6a50cd7:0x422eea91c4c7bfce!2sPantai+payangan!8m2!3d-8.436409!4d113.581299!16s%2Fg%2F11pz8tfyph!3m5!1s0x2dd4272ca6a50cd7:0x422eea91c4c7bfce!8m2!3d-8.436409!4d113.581299!16s%2Fg%2F11pz8tfyph?entry=ttu");
    if (!await launchUrl(
      uri,
