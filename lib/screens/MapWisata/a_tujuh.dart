...
import 'package:onvocation/sharedfoto/image_7bidadari.dart';

class A_tujuh extends StatefulWidget {
  const A_tujuh({Key? key}) : super(key: key);

  @override
  State<A_tujuh> createState() => _MainScreenState();
}

class _MainScreenState extends State<A_tujuh> {
  final String menuName = 'Air Terjun Tujuh Bidadari';
  String name = '';
  String category = '';
  String address = '';
  String price = '';
  ...
  LatLng destinationPosition = LatLng(-8.073737587112035, 113.93830641000498);
  ...
  Future<void> _launchURL(String url) async {
    final Uri uri = Uri.https("www.google.com",
        "maps/place/Air+Terjun+Tujuh+Bidadari/@-8.0739235,113.9356886,17z/data=!3m1!4b1!4m6!3m5!1s0x2dd6c7eef8fd2f33:0x248386171feb1d9f!8m2!3d-8.0739288!4d113.9382635!16s%2Fg%2F11c5494d83?entry=ttu");
    if (!await launchUrl(
      uri,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(
                                "https://firebasestorage.googleapis.com/v0/b/onvocation-81249.appspot.com/o/Air%20Terjun%207%20Bidadari.jpg?alt=media&token=e20b6b55-d812-45f3-bbec-7df5e2229e38&_gl=1*13ycslh*_ga*MTAxMTI3MzE5Mi4xNjg1MTAyMzI2*_ga_CW55HF8NVT*MTY4NjU2MTU4MC44LjEuMTY4NjU2MzgyMS4wLjAuMA."),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => Image7Bidadari()),
                                );
                              },
                              child: Text(
                                'Upload Foto',
