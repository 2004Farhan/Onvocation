...
import 'package:onvocation/screens/MapWisata/a_tujuh.dart';
...
class Air_terjun_tujuh_bidadari extends StatefulWidget {
  @override
  _YourPageState createState() => _YourPageState();
}

class _YourPageState extends State<Air_terjun_tujuh_bidadari> {
  List<Menu> allMenus = [];
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      QuerySnapshot querySnapshot = await menuCollection
          .where('name', isEqualTo: 'Air Terjun Tujuh Bidadari')
          .get();
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => A_tujuh()),
                    );
                  },
