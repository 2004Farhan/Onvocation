...
import 'package:onvocation/screens/MapWisata/g_ijen.dart';
...
class Kawah_ijen extends StatefulWidget {
  @override
  _YourPageState createState() => _YourPageState();
}

class _YourPageState extends State<Kawah_ijen> {
  List<Menu> allMenus = [];
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      QuerySnapshot querySnapshot =
          await menuCollection.where('name', isEqualTo: 'Kawah Ijen').get();
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => G_ijen()),
                    );
                  },
