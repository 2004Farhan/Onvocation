...
import 'package:onvocation/screens/MapWisata/g_rembangan.dart';
...
class Rembangan extends StatefulWidget {
  @override
  _YourPageState createState() => _YourPageState();
}

class _YourPageState extends State<Rembangan> {
  List<Menu> allMenus = [];
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      QuerySnapshot querySnapshot = await menuCollection
          .where('name', isEqualTo: 'Rembangan Public Bath')
          .get();
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => G_rembangan()),
                    );
                  },
