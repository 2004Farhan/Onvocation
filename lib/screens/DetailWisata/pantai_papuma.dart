...
import 'package:onvocation/screens/MapWisata/p_papuma.dart';

import 'package:onvocation/sharedfoto/image_papuma.dart';
...
class Pantai_papuma extends StatefulWidget {
  @override
  _YourPageState createState() => _YourPageState();
}

class _YourPageState extends State<Pantai_papuma> {
  List<Menu> allMenus = [];
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      QuerySnapshot querySnapshot =
          await menuCollection.where('name', isEqualTo: 'Pantai Papuma').get();
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => P_papuma()),
                    );
                  },
