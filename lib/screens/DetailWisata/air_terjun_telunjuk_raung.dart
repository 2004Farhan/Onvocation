...
import 'package:onvocation/screens/MapWisata/a_telunjuk.dart';
...
class Air_terjun_telunjuk_raung extends StatefulWidget {
  @override
  _YourPageState createState() => _YourPageState();
}

class _YourPageState extends State<Air_terjun_telunjuk_raung> {
  List<Menu> allMenus = [];
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      QuerySnapshot querySnapshot = await menuCollection
          .where('name', isEqualTo: 'Air Terjun Telunjuk Raung')
          .get();
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => A_telunjuk()),
                    );
                  },
