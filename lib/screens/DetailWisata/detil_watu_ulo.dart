...
import 'package:onvocation/screens/MapWisata/p_watu.dart';
...
class Watu_ulo extends StatefulWidget {
  @override
  _YourPageState createState() => _YourPageState();
}

class _YourPageState extends State<Watu_ulo> {
  List<Menu> allMenus = [];
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      QuerySnapshot querySnapshot = await menuCollection
          .where('name', isEqualTo: 'Pantai Watu Ulo')
          .get();
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => P_watu()),
                    );
                  },
